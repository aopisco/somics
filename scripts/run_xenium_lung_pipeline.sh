...
#
# The staging, harmonization and finalization steps live in polycomb's own
# Claude skills, installed separately from the package:
#
#   curl -sSL https://raw.githubusercontent.com/epiblastai/homeobox/refs/heads/main/packages/polycomb/install.sh | bash
#
# Set SOMICS_DATA_HOME to run against data anywhere other than the hackathon
# box, and POLYCOMB_SKILLS if the installer put the skills somewhere else.
#
# Run:
