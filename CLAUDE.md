...
| **verification run 3 (launched 2026-09-10 13:31Z, `somics-verify-final-3`, `i-0b3a92d9ab041c9c5`)** | report under `ingest/merfish/atlas/2026-09-10T03-01-26Z/_verify/2026-09-10T13-3*/` | run 1 covered one section (shell expanded the globs; fixed); run 2: Visium **1408/1416**, 7 sections fail `obs inside image` (rows at negative px; builder pads only right/bottom) + 1 IF crop heuristic; the verifier crashed on cell-unit specs (fixed). Run 3 reports min px and the count of negative rows |
